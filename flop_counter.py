...
# from models import SparseCoding, SparseAutoEncoder, GatedAutoEncoder
...
# def measure_flops(model, input_data):
#     flop_count = FlopCountAnalysis(model, input_data)
...
#         GatedAutoEncoder(D, learn_D=False)
#     ]
